...
public class FileMain09 {
	...
	public static void main(String[] args) {
		 ...
		 *   (예) C:\workspaces\danbi22.github.io\Java13_File\data\encoding-ansi.txt
		 *   
		 * 상대 경로(relative path)
		...
		// backslash가 포함된 문자열
		System.out.println("C:\\workspaces\\danbi22.github.io\\Java13_File\\data\\encoding-ansi.txt");
		
		// 프로그램이 실행되는 OS에 따라서 자동으로 파일 구분자가 선택되도록 할 수 있음. // 안전한 방법
		...
		System.out.println("파일크기: " + f.length()); // 바이트(byte) 단위
